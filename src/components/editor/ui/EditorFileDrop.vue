<template>
  <div class="editor-filedrop" @dragover="onDragOver" @drop="onDrop" @dragenter="dropReady = true" @dragleave="dropReady = false">
    <div class="block" v-if="!dropReady">
      ...
      <button class="eui button text" @click="openFileDialog">{{$t('editor.selectFile')}}</button>
    </div>
...
export default defineComponent({
  ...
  setup(_props, { emit }) {
    ...
    return {
      dropReady, fileInput,
      onDragOver, onDrop, openFileDialog, onFileSelect
    }
  },
})
</script>
