<template>
  <aside class="editor-sidebar">
    <button class="expand eui circleButton" @click="expanded = !expanded" :class="{expanded}">
    ...
    <div class="content" :class="{expanded}">
      ...
      <div class="menu" v-else>
        ...
        <router-link to="/editor/list/levels">{{$t('editor.levels')}} <span class="count">{{editor.levels.size}}</span></router-link>
        <router-link to="/editor/list/rooms">{{$t('editor.rooms')}} <span class="count">{{editor.rooms.size}}</span></router-link>
        <router-link to="/editor/list/monsters">{{$t('editor.monsters')}} <span class="count">{{editor.monsters.size}}</span></router-link>
        <router-link to="/editor/indev">{{$t('editor.bosses')}} <span class="count">{{editor.bosses.size}}</span></router-link>
        <router-link to="/editor/indev">{{$t('editor.objects')}} <span class="count">{{editor.objects.size}}</span></router-link>
        <router-link to="/editor/indev">{{$t('editor.items')}} <span class="count">{{editor.items.size}}</span></router-link>
