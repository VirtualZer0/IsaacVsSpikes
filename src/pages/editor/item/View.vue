<template>
  <div class="item-editor-view eui edit-form">
...
const selectedAnimationId = ref(props.item.animations[0]?.id ?? null);
const selectedAnimation = computed(
  () =>
    curItem.animations.find((anim) => anim.id == selectedAnimationId.value) ??
    null
);
